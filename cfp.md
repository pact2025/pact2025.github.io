...
* The paper must be original material that has not been previously published in another conference or journal, nor is currently under review by another conference or journal. You may submit our own material that was (1) presented previously at a workshop without archived or copyrighted proceedings (including workshops where the authors chose not to have their work included in the proceedings) or (2) published to venues such as arXiv or IEEE CAL that have an explicit policy that do not preclude longer conference submissions.
...
* Paper submission is double-blind to reduce reviewer bias against authors or institutions. Thus, the submissions cannot include author names, institutions or hints based on references to prior work. If authors are extending their own work, they need to reference and discuss the past work in third person, as if they were extending someone else’s research. We realize that for some papers authorship will still be revealed, but as long as an effort was made to follow these guidelines, the submission will not be penalized. Works that have been published before (see above) do not have to preserve author anonimity, but must declare the venue of the publication in the paper.
